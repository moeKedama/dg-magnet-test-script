...
def get_args():
    ...
    parser.add_argument('--data_file', type=str, default='',
                        help='root_dir')
    # parser.add_argument('--dataset', type=str, default='MAGNET_3')
    # parser.add_argument('--dataset', type=str, default='MAGNET_7')
    parser.add_argument('--dataset', type=str, default='MAGNET_N')
...
if __name__ == '__main__':
    ...
    # norm_dict = init_norm_dict("var_file/sub_domain/variables_3.npz")
    # norm_dict = init_norm_dict("var_file/sub_domain/variables_7.npz")
    norm_dict = init_norm_dict("var_file/sub_domain/variables_N_ex.npz")
    ...
    pth_PATH = "pth_file/subdomain/N/ViT_sub_N_3201.pth"
    ...
    for key, value in item_dict_template.items():
        filename = f"pred_file/subdomain/pred_{key}.csv"
